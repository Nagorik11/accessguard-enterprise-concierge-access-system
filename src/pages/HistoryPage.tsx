...
import { Search, Download, Filter, Calendar, FileText, Loader2 } from 'lucide-react';
              ...
              <Table>
                <TableHeader>
                  <TableRow className="hover:bg-transparent border-slate-100">
                    ...
                    <TableHead className="text-[10px] font-bold uppercase text-slate-400">Motivo</TableHead>
                ...
                <TableBody>
                  {filteredVisits.map((v) => (
                    <TableRow key={v.id} className="border-slate-50 hover:bg-slate-50/50 transition-colors">
                      ...
                      <TableCell className="text-slate-600 text-xs">{v.purpose}</TableCell>
                      <TableCell>
